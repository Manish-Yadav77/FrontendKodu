...
function QuestionCard({ title, discription }) {
  ...
  return (
    <div className="flex flex-col items-center bg-white w-260 rounded-2xl">
      <h4 className="text-black text-2xl bg-white shadow-2xl text-center pt-3 pl-3 w-full rounded-2xl flex flex-row h-16 gap-3 items-center justify-between px-4">
        {title}
